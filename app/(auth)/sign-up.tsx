import { codeSchema, SignUpFormValues, signUpSchama } from "@/lib/schemas/auth";
    ...
    <KeyboardAvoidingView
      ...
      <View className='flex-1 justify-center px-6 -mt-16'>
        ...
        <View className='flex-row justify-center'>
          ...
          <Link href='/sign-in'>
            <Text className='text-brand-blue font-semibold'>Sing In</Text>
          </Link>
        </View>
